    ...
    public class PieceView : MonoBehaviour
    {
        ...
        private void RenderPiece(Piece piece)
        {
            ...
            foreach (var block in piece.blocks)
            {
                ...
                Debug.Log("block.type "+ block.Type + " themeProvider.currentTheme.BlockSprites "+themeProvider.currentTheme.BlockSprites );
        ...
        {
            return themeProvider.currentTheme.BlockSprites[(int)type];
        }
    }
}
